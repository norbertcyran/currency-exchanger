          ...
          <v-container>
            <v-row>
              ...
              <v-col cols="12" sm="6" md="6">
                <v-text-field label="Ammount" v-model="amount" 
                 :rules="[rules.available]" type="number" required> </v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <v-text-field label="Price" v-model="cost"  disabled></v-text-field>
              </v-col>
            </v-row>
          </v-container>
        </v-card-text>
